...
SETTING_DEFINITIONS: tuple[SettingDefinition, ...] = (
    ...
    _setting(
        ...
        description=(
            "Public browser-visible PlexIntel URL used in agent/MCP image and media markup. Required when external "
            "agents need absolute poster URLs. Set this to your reverse-proxy or public container URL."
        ),
    ),
    _setting(
        "mcp.enabled",
    ...
    _setting(
        ...
        "training_scoring",
        "Movie Revisit Pending Days",
        "integer",
        default=21,
        description="Number of days to wait before treating a meaningful partial movie watch as inferred abandonment.",
        minimum=0,
    ),
    _setting(
        "training.tv_revisit_pending_days",
        "training_scoring",
        "TV Revisit Pending Days",
        "integer",
        default=14,
        description="Number of days to wait before treating a meaningful partial episode watch as inferred abandonment.",
        minimum=0,
    ),
    _setting(
