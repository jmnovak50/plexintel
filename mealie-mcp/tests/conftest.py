...
def settings() -> Settings:
    return Settings(
        ...
        account_oidc_issuer="https://auth.example.com/application/o/mealie-mcp-account/",
        account_oidc_client_id="mealie-mcp-account-client",
        account_oidc_client_secret="test-account-client-secret",
        account_redirect_uri="https://mcp.example.com/account/callback",
        account_public_url="https://mcp.example.com/account",
        account_session_secret="test-account-session-secret-at-least-32-characters",
