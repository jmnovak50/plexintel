...
export default function AdminSettings() {
  ...
  return (
    <AppShell
      eyebrow="Settings"
      title="Live application settings"
      description="Save operational settings to Postgres, test external services, and stop relying on a long-lived root .env."
      ...
      {loading ? (
        ...
        <div className="grid gap-5">
          {sections.map((section) => (
            <section key={section.key} className="recs-surface p-5">
                        ...
                        <div className="mt-4 space-y-3">
                          ...
                          <div className="flex flex-wrap items-start justify-between gap-3 text-xs text-slate-500">
                            ...
                            <button
                              ...
                              className="recs-btn-secondary px-3 py-1.5 text-xs"
                            >
                              Reset to default
                            </button>
                          </div>
